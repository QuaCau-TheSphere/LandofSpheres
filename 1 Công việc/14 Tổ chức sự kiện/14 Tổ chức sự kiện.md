...
Tính chất công việc:: Tương tác nhiều với loài người
...
Where file.name!=this.file.name and (độ-cấp-thiết="Phải làm ngay" or độ-cấp-thiết="Muốn làm ngay" or độ-cấp-thiết="Nên làm ngay" or độ-cấp-thiết="Công việc lặp lại" )
```
## Tất cả
```dataview 
List from "1 Công việc/14 Tổ chức sự kiện" 
