...
Tính chất công việc:: Có thể làm qua mạng, Tương tác nhiều với loài người
...
Kết quả mong muốn:: 
##### Chỉ số trước
- [ ] Buổi tổ chức thử có 60% người quay lại
```dataview
List without id công-việc-thành-phần.kết-quả-mong-muốn
Where file.name=this.file.name
```

Công việc thành phần:: [[Tổ chức thử buổi nói chuyện về chức năng của người thân bạn bè cho nội bộ]]
