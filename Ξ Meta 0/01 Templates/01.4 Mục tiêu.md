	...
	tp.file.move("/4 Sản phẩm, kết quả mong muốn (các vùng đất)" + (
		await tp.system.suggester(
			...
			[ 
				...
				"4B Sàn giao dịch nhu cầu",
				"4C Nhóm hỗ trợ cho người tự học quản lý dự án hoặc lập trình",
				"4D Cộng đồng trên Discord",
				"4E Mạng lưới người thân bạn bè của người có niềm tin tiêu cực",
				"4F Các buổi nói chuyện, thuyết trình, dã ngoại",
				"4G Trang hỏi đáp liên lĩnh vực",
				"4H Nhóm nghiên cứu liên ngành",
				"4I Cầu nối cho các sáng kiến quốc tế",
				"4J Đồ thị mạng lưới 100+ niềm tin trong xã hội",
				"4K Các bài dịch về tự trị, riêng tư, đồng thuận, thao túng, v.v",
				"Khác",
				"4L Dự án nâng cao hiểu biết ở các nhà hoạt động xã hội về các quá trình nhận thức và ngôn ngữ",
				"4M Dự án nâng cao nhận thức của mọi người về việc tình yêu thực sự khác với sự nuông chiều, khao khát, và cũng không phân biệt giới tính",
				"4N Dự án nâng cao hiểu biết của người có niềm tin Phật pháp về những xung đột trong những cách hiểu của Phật giáo về trí tuệ",
				"4O Dự án nâng cao mối quan tâm của nghệ sĩ và người làm trong ngành giải trí và văn hóa đại chúng về những tác hại dù không muốn nhưng không thể tránh khỏi mà ngành của mình tạo ra",
				"4P Nền tảng dịch thuật ngữ",
				"4Q Nhóm hỗ trợ nhà nghiên cứu nghiệp dư",
			] 
		)
	)  + "/" + tp.file.title)
} %>