...
> ```button
> id kiemtrengoogle
> action https://www.google.com/search?q=20kỹ%20năng%20Dùng%20Git
> ```
> ```button
> name Kiếm trên Google (PDF) 
> id kiemtrengoogle
> action https://www.google.com/search?q=type:pdf%20kỹ%20năng%20Dùng%20Git
> ```
> ```button
> id kiemtrenyoutube
> action https://www.youtube.com/search?q=%20Dùng%20Git
> ```
