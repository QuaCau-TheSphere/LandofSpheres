...
## 1. Chuẩn bị dữ liệu
### 1.1 Chuẩn bị phần mềm
Bạn vui lòng tải và cài đặt 3 phần mềm sau:
```button
Name Obsidian
type link
...
color blue
```
^button-obsidiandownload
```button
Name Git
type link
Action https://git-scm.org
color blue
```
^button-obsidiandownload
```button
...
```
^button-obsidiandownload
Khi cài bạn cứ nhấn Next là được, không cần quan tâm nó nói gì đâu
### 1.2 Tải dữ liệu
Mở GitKraken
Tạo tài khoản trên GitHub https://i.imgur.com/DDAsOTJ.png
Create Profile https://i.imgur.com/Tw49rze.png
Clone https://i.imgur.com/1E779Xo.png
Nhập đường dẫn https://i.imgur.com/izwqKUP.png
## 2. Mở dữ liệu trên Obsidian
### 2.1 Chọn open vault
https://i.imgur.com/nij7Tot.png
![[2. Mở dữ liệu trên Obsidian.png]]
### 2.2 Chọn trust author
![[3. Chọn trust author.png]]

## 3. Mở file cần đọc
![[4. Mở file cần đọc.png]]

Hình ảnh các file cần đọc
