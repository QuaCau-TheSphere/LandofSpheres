...
# Phần 2
Khi lập bất cứ dự án nào, ta cần phải xác định rõ Thành quả cần có, nhu cầu, sản phẩm, điểm mạnh, điểm yếu, các bên liên quan, v.v. Những thành phần này liên kết với nhau và tạo thành một mạng lưới lớn. Giả sử như ta lập được một mạng lưới mối liên hệ giữa các nhu cầu và sản phẩm thế này:
